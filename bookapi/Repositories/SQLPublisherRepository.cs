...
namespace bookapi.Models.DTO
{
    public class SQLPublisherRepository : IPublisherRepository
    {
        ...
        public List<PublisherDTO> GetAllPublishers()
        {
            ...
            foreach (var publisherDomain in allPublishersDomain)
            {
                allPublisherDTO.Add(new PublisherDTO()
                {
                    ...
                    Name = publisherDomain.PublisherName
                });
            }
        ...
        public PublisherNoIdDTO GetPublisherById(int id)
        {
            ...
            var publisherWithIdDomain = _dbContext.Publishers.FirstOrDefault(x => x.PublisherID ==
           id);
            if (publisherWithIdDomain != null)
            { //Map Domain Model to DTOs
                var publisherNoIdDTO = new PublisherNoIdDTO
                {
                    Name = publisherWithIdDomain.PublisherName,
                };
       ...
       addPublisherRequestDTO)
        {
            ...
            {
                PublisherName = addPublisherRequestDTO.Name,
            };
       ...
       publisherNoIdDTO)
        {
            ...
            {
                publisherDomain.PublisherName = publisherNoIdDTO.Name;
                _dbContext.SaveChanges();
            }
            return null;
        }
